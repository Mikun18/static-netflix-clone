      ...
      <section className="faq">
        <div className="question">
          <div className="sub">
            ...
            <button
              className="faq-btn"
              onClick={() => setQuestion({ first: !question.first })}
            >
              +
            </button>
          </div>
        ...
        <div className="question">
          <div className="sub">
            ...
            <button
              className="faq-btn"
              onClick={() => setQuestion({ second: !question.second })}
            >
              +
            </button>
          </div>
        ...
        <div className="question">
          <div className="sub">
            ...
            <button
              className="faq-btn"
              onClick={() => setQuestion({ third: !question.third })}
            >
              +
            </button>
          </div>
        ...
        <div className="question">
          <div className="sub">
            ...
            <button
              className="faq-btn"
              onClick={() => setQuestion({ fourth: !question.fourth })}
            >
              +
            </button>
          </div>
        ...
        <div className="question">
          <div className="sub">
            ...
            <button
              className="faq-btn"
              onClick={() => setQuestion({ fifth: !question.fifth })}
            >
              +
            </button>
          </div>
        ...
        <div className="question">
          <div className="sub">
            ...
            <button
              className="faq-btn"
              onClick={() => setQuestion({ sixth: !question.sixth })}
            >
              +
            </button>
          </div>
